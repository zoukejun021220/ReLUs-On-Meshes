! function(e) {
        ...
        s = {
            ...
            set: function(e, t, i, o, s, a) {
                ...
                if (i) switch (i.constructor) {
                    case Number:
                        r = 1 / 0 === i ? "; expires=Fri, 31 Dec 9999 23:59:59 GMT" : "; max-age=" + i;
                        break;
                    case String:
                        r = "; expires=" + i;
                        break;
            ...
            merge: function() {
                ...
                if (0 === n) return t;
                for (; n > i; i++)
                    for (e in arguments[i]) arguments[i].hasOwnProperty(e) && (t[e] = arguments[i][e]);
                return t
            },
            str2bool: function(e) {
            ...
            get_data_attribs: function(e) {
                var t = {};
                if (e.hasOwnProperty("dataset")) t = e.dataset;
                else {
            ...
            find_script_by_id: function(e) {
                for (var t = n.getElementsByTagName("script"), i = 0, o = t.length; o > i; i++)
    ...
    c.prototype = {
        ...
        init: function(t) {
            ...
            t && (this.options = a.merge(this.options, t)), o = this.options.instance, this.options.zindex = parseInt(this.options.zindex, 10), this.options.mask = a.str2bool(this.options.mask), "string" == typeof this.options.expires && "function" == typeof e[this.options.expires] && (this.options.expires = e[this.options.expires]), "function" == typeof this.options.expires && (this.options.expires = this.options.expires()), this.script_el && this.run()
        },
        log: function() {
        ...
        close: function() {
            return this.inserted && (this.closed || (this.element && n.body.removeChild(this.element), this.element_mask && n.body.removeChild(this.element_mask), this.closed = !0)), this.closed
        },
        ...
        insert: function() {
            ...
            o.target = "_blank", o.style.textDecoration = "none", o.style.color = this.options.link;
            ...
            e(s, "click", function() {
                ...
                r.agree_and_close()
            }), n.body.appendChild(this.element_mask)), n.body.appendChild(this.element), this.inserted = !0, "fade" === this.options.effect ? (this.element.style.opacity = 0, a.fade_in(this.element)) : this.element.style.opacity = 1
        }
    }, r && (e[o] || (e[o] = new c))
}(window);