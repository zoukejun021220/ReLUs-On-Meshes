...
def parse_args(argv=None):
    ...
    ap.add_argument("mesh", help="Input .vtk/.vtp, .npz, or .mesh (Medit) surface")
    ...
    ap.add_argument("--seed-file", default=None, help="Text file with seed vertex indices (optional label per line)")
    ap.add_argument("--seed-label", default="seed", help="Default label used for marked seeds")
...
def main(argv=None):
    ...
    visualize(
        ...
        mark_seeds=args.mark_seeds or bool(args.seed_file) or bool(args.seeds),
